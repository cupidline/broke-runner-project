...
// Handles threshold / VO2max / hills interval workouts
export default function IntervalsCard({ workout }: { workout: Workout }) {
  return (
    <div className="space-y-3">
      ...
      {workout.segments && workout.segments.length > 0 ? (
        ...
        <p className="text-sm text-text-secondary">{workout.durationMin} min interval effort</p>
      )}

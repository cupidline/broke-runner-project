...
// Tempo: 3-segment layout (warm-up / main / cool-down)
export default function TempoCard({ workout }: { workout: Workout }) {
  return (
    <div className="space-y-3">
      ...
      {workout.segments && workout.segments.length > 0 ? (
        ...
        <p className="text-sm text-text-secondary">{workout.durationMin} min tempo effort</p>
      )}
